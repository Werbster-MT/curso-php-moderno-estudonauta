...
<body>
    ...
    <section>
        ...
        <p>O produto que custava R$<?=number_format($preco, 2, ",", ".")?>, com <strong><?=$aumento?> % de aumento</strong> vai passar a custar <strong>R$ <?=number_format($novo, 2, ",", ".")?></strong> a partir de agora.</p>
    </section>

    <script>
        mudaValor()
        function mudaValor() {
            let span = window.document.getElementById('p');
            span.innerText = reaj.value;
        }
    </script>
